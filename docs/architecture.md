...
32 модели, одна таблица — один файл (`backend/app/models/`). Крупными блоками:
...
Миграции — 24 ревизии в `backend/alembic/versions/`, **forward-only**: `downgrade()` кидает
...
Правила инцидентов и шаблоны писем поставщику — тоже данные, а не код (ADR-015): правило
...
Сейчас в контракте 76 путей, 97 операций, 175 схем, 13 тегов. Ошибки у всех операций
