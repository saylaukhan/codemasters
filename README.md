...
панели, Docker Compose, CI. Готова схема БД v1 (T-02): справочники, школы, линии, точки,
устройства, замеры и heartbeats (hypertables TimescaleDB), `make migrate`. Функции ТЗ не
реализованы. Идёт этап 0 плана (plan.md §14): дальше T-03 (контракт API), T-04 (GeoJSON
районов и тестовые школы), T-05 (сервер замеров).
