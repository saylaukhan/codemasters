...
/**
 * ИИ-помощник по интерфейсу (T-84, ADR-017): кнопка в шапке, боковая панель с диалогом и
 * частые вопросы открытого экрана. Помощник объясняет панель, а не данные: ответ приходит с
 * сервера, где модели дано описание панели и ничего из базы.
 */
export const ASSISTANT_LABELS = {
  title: 'Көмекші',
  open: 'Көмекшіні ашу',
  welcome:
    'Панельді қалай пайдалану керектігін сұраңыз: бөлімді қайдан табуға болады, мәртебе нені білдіреді, өтінішті қалай жіберу керек.',
  suggestions: 'Осы экрандағы жиі қойылатын сұрақтар',
  placeholder: 'Панель туралы сұрағыңыз',
  ask: 'Сұрау',
  restart: 'Қайта бастау',
  you: 'Сіз',
  assistant: 'Көмекші',
  thinking: 'Көмекші жауап жазып жатыр',
  disclaimer:
    'Көмекші панельдің сипаттамасы бойынша жауап береді және мектептердің деректерін көрмейді. Маңыздысын панельдің өзінде тексеріңіз.',
} as const

/** Частые вопросы по экранам панели (T-84): ключ — экран `AssistantScreen` контракта, в обоих словарях поровну. */
export const ASSISTANT_SUGGESTIONS: Record<AssistantScreen, readonly string[]> = {
  overview: [
    'Мәртебелер жолағы нені білдіреді?',
    '«Сыни» мәртебедегі мектептерді қалай ашуға болады?',
    '«Назар қажет» тізіміне не түседі?',
  ],
  map: [
    'Картадан мектепті қалай табуға болады?',
    'Картадағы нүктелердің түстері нені білдіреді?',
    'Мектептерді аудан бойынша қалай сүзуге болады?',
  ],
  schools: [
    'Мектепті коды бойынша қалай табуға болады?',
    '«Деректер жоқ» мәртебесі нені білдіреді?',
    'Мектеп карточкасын қалай ашуға болады?',
  ],
  school_card: [
    'Жеткізушіге өтінішті қалай жасауға болады?',
    'Мектептің шарты мен желілерін қайдан көруге болады?',
    'Жауапты тұлғаны қалай қосуға болады?',
  ],
  school_cabinet: [
    'Интернет баяу болса не істеу керек?',
    'Неге «Агент орнатылған компьютер өшірулі» деп жазылған?',
    'Жеткізушіге мәселе туралы қалай хабарлауға болады?',
    'Тақтайшалардағы «норма» мен «шарт» нені білдіреді?',
  ],
  device_card: [
    '«Желіні бағаламайды» нені білдіреді?',
    'Компьютер неге бұғатталған?',
    '30 күндегі өлшемдерді қалай көруге болады?',
  ],
  incidents: [
    'Инцидент қалай ашылады?',
    '«Тізім» «Тақтадан» несімен ерекшеленеді?',
    'Инцидентті нөмірі бойынша қалай табуға болады?',
  ],
  incident_card: [
    'Инцидентті басқа мәртебеге қалай ауыстыруға болады?',
    'Инцидент бойынша өтінішті қалай жасауға болады?',
    'Негіздеме көрсеткіштері нені білдіреді?',
  ],
  appeals: ['Өтініш жобалары қайда?', '«Жіберілмеді» нені білдіреді?', 'Жаңа өтінішті қалай жасауға болады?'],
  appeal_draft: ['Хат мәтінін өзгертуге бола ма?', '«Қайта жасау» не істейді?', 'Жібергеннен кейін не болады?'],
  appeal_card: [
    'Өтініштің PDF-ін қалай жүктеп алуға болады?',
    'Өтінішті кім жаба алады?',
    'Түсініктемені қалай қосуға болады?',
  ],
  providers: [
    'Жеткізушінің бағасы қалай есептеледі?',
    '«Шарт нормадан төмен» деген не?',
    'Актіні қалай жүктеп алуға болады?',
  ],
  rollout: ['«Үнсіз» нені білдіреді?', 'Агент жаңартуын қалай тағайындауға болады?', 'Орнату кодын қалай беруге болады?'],
  analytics: ['Мектептерді қалай салыстыруға болады?', 'Жылу картасы нені көрсетеді?', 'Өз кезеңімді қалай таңдауға болады?'],
  exports: [
    'Өлшемдерді XLSX-ке қалай жүктеп алуға болады?',
    'Агрегаттар шикі деректерден несімен ерекшеленеді?',
    'Дайын жүктеп алуды қайдан алуға болады?',
  ],
  admin: [
    'Сапа шектерін қалай өзгертуге болады?',
    'Агентті орнату кодын қалай беруге болады?',
    'Пайдаланушыны қалай бұғаттауға болады?',
  ],
