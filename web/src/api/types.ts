...
// a rule of one school replaces the global rule of its metric for that school (T-59).
...
// Contract import of the administration (T-61): a CSV or XLSX registry into the lines of schools.
...
// Letter templates of the administration (T-60): the model writes by a template filled with the facts.
