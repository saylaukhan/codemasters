...
``ollama`` — a model of a closed loop next to the server. The key lives only in the
environment (``LLM_API_KEY``), never in the code, in the database or in the panel (ТЗ п. 12).
