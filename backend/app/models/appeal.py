...
letter it was and which template it was written by (T-60). Rows are never deleted; every
...
class Appeal(TimestampMixin, Base):
    ...
    status: Mapped[str]
    # An ordinary appeal or a formal claim; the template it was written by (T-60).
